...
export default function Tache(props) {
	...
	switch(tache.label.color) {
		case 'gray': labelClassName = 'bg-gray-100 text-gray-700'; borderColor = 'border-gray-400'; break;
		case 'orange': labelClassName = 'bg-yellow-100 text-yellow-700'; borderColor = 'border-yellow-400'; break;
		case 'red': labelClassName = 'bg-red-100 text-red-700'; borderColor = 'border-red-400'; break;
		case 'green': labelClassName = 'bg-green-100 text-green-700'; borderColor = 'border-green-400'; break;
		default: labelClassName = 'bg-gray-100 text-gray-700'; borderColor = 'border-gray-400'; 
	}
	...
	return (
		...
		<div className={cx(borderColor, "section rounded-md border border-l-2 shadow-sm transition-all hover:shadow-xl")}>
			...
			<div className="mt-3 text-xs text-gray-500 flex flex-row justify-between font-light">
				...
				<div className={cx(labelClassName, "rounded py-1 px-3 uppercase font-normal cursor-pointer")}>
					{tache.label.text}
				</div>
