...
export default function Tache(props) {
	...
	const clientTelClass = fix !== '' || gsm !== '' ? 'mt-2 text-xs text-gray-500' : 'hidden';
	...
	const commentsClass = comments.length > 0 ? 'my-2 mt-3 text-sm text-gray-600' : 'hidden';
	...
	return (
		...
		<div className="section border-l-3  transition-all hover:bg-white hover:border-yellow-300">
			<div className="flex flex-row justify-between">
				...
				<div>
					...
					<div className="text-xs text-gray-500 mt-1">
						<div className="inline-block w-4 h-4 mr-3 align-bottom">
			...
			<div className={commentsClass}>
				<div className="inline-block w-4 h-4 mr-3 align-top">
				...
				<div className="inline-block relative" style={{ top: '-2px' }}>
			...
			<div className={clientTelClass}>
				{fix !== '' && 
					<p>
						<div className="inline-block w-4 h-4 mr-3 align-bottom">
							<svg viewBox="0 0 74 74"><path opacity="0.77" d="m26.22 60.78h-2.9a1 1 0 1 1 0-2h2.9a1 1 0 0 1 0 2z"/><path opacity="0.77" d="m62.2 60.78h-19.01a1 1 0 0 1 0-2h19.01a1 1 0 0 0 1-1v-11.21a1.006 1.006 0 0 0 -.379-.783l-10.127-8.127a1 1 0 0 1 -.374-.78v-8.74h-30.64v8.74a1 1 0 0 1 -.374.78l-10.13 8.13a1 1 0 0 0 -.376.78v11.21a1 1 0 0 0 1 1h4.52a1 1 0 0 1 0 2h-4.52a3 3 0 0 1 -3-3v-11.21a3 3 0 0 1 1.121-2.338l9.759-7.832v-9.26a1 1 0 0 1 1-1h32.64a1 1 0 0 1 1 1v9.26l9.756 7.83a3 3 0 0 1 1.124 2.34v11.21a3 3 0 0 1 -3 3z"/><path opacity="0.77" d="m36.19 60.78h-2.97a1 1 0 0 1 0-2h2.97a1 1 0 0 1 0 2z"/><path opacity="0.77" d="m68.28 36.517h-12.24a3.724 3.724 0 0 1 -3.72-3.72v-4.657h-30.64v4.66a3.724 3.724 0 0 1 -3.72 3.72h-12.24a3.724 3.724 0 0 1 -3.72-3.72v-5.34c0-8.785 11.775-13.24 35-13.24s35 4.455 35 13.24v5.34a3.724 3.724 0 0 1 -3.72 3.717zm-47.6-10.377h32.64a1 1 0 0 1 1 1v5.66a1.722 1.722 0 0 0 1.72 1.72h12.24a1.722 1.722 0 0 0 1.72-1.72v-5.34c0-7.353-11.411-11.24-33-11.24s-33 3.887-33 11.24v5.34a1.722 1.722 0 0 0 1.72 1.72h12.24a1.722 1.722 0 0 0 1.72-1.72v-5.66a1 1 0 0 1 1-1z"/><path opacity="0.77" d="m37 55a9.625 9.625 0 1 1 9.625-9.625 9.636 9.636 0 0 1 -9.625 9.625zm0-17.25a7.625 7.625 0 1 0 7.625 7.625 7.634 7.634 0 0 0 -7.625-7.625z"/></svg>
			...
			<div className="mt-2 text-xs text-gray-500 flex flex-row justify-between">
				<div>
					<div className="inline-block w-4 h-4 mr-3 align-bottom">{activityIcon}</div>
...
const activityIcon = <>
	<svg viewBox="0 0 511.978 511.978">
