		...
		<div className="section border-l-3  transition-all hover:bg-white hover:border-yellow-300">
			...
			<div className="flex flex-row justify-between">
				<div>
					...
					<div className="text-base text-gray-700 font-bold">{tache.description}</div>
				...
				<div className="text-gray-500 text-xs text-right font-light">
					<div>Début:<input className="inputClass ml-2 pl-2 text-sm font-normal" type="time" data-array="taches" data-index={props.index} name="taches.start_at" value={tache.start_at} onChange={props.onChangeCallback} /></div>
					<div>Fin: <input className="inputClass ml-2 pl-2 text-sm font-normal" type="time" data-index={props.index} name="taches.stop_at" value={tache.stop_at} onChange={props.onChangeCallback} /></div>
