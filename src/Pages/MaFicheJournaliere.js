...
function Fiche(props) {
  ...
  function addNewTacheHandler() {
    let newTache = {
      ...
      chantier_adr: `<L'adresse du chantier>`,

      activite_name: `<Nom de l'activité>`,
    ...
    fiche.taches.push(newTache);
    setFiche(Object.assign({}, fiche));
    ...
    <div>
      ...
      <form onSubmit={formSubmit}>
        ...
        <div>
          ...
          <div className="my-4">
            <RoundButton signe="+" text="Ajouter une tâche" onClick={addNewTacheHandler} />
          </div>
        ...
        <div className="my-4">
          <button className={submitBtnClass}>
            {internetAvaible === true ? <>Envoyer {sendIcon}</> : 'Enregistrer le brouillon'}
          </button>
        </div>
